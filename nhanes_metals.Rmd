...
nh1516_sub %>%
  count(is.na(lbxbpb))
# 10.88% still missing data.... seems extremely high 
...
# so should conduct t tests on the log transformed data

# Arsenic
############################################
svyhist(~urxuas,
        arsenic.svy,
        main = "Survey weighted average urinary As", col = "blue")

# log transformed
svyhist(~log(urxuas),
        arsenic.svy,
        main = "Survey weighted log(average urinary As)", col = "blue")
