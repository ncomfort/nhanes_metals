...
# create separate dataset for speciated mercury, including only the complete cases
hg1516 <- 
  nh1516_sub %>% drop_na(lbxbge)
...
# I think that these metals (Pb, Cd, Hg, Mn) were measured in everybody, check the data documentation and double-check with Annie
