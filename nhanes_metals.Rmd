...
pb_sex_means %>% 
  ...
  labs(title = "Blood Pb Levels, Males vs Females", # edit labels for diff graphs
       x = "Sex",
       y = "Blood Pb (ug/dL)") 
...
cd_sex_means %>% 
  ...
  geom_errorbar(aes(ymin = lower, # change for different metals
                    ...
                    position = position_dodge(0.9)) +
  geom_signif(comparisons = list(c("Female", "Male")), annotations = "***") +
  labs(title = "Blood Cd Levels, Males vs Females", # edit labels for diff graphs
       x = "Sex",
       y = "Blood Cd (ug/L)") 
...
mn_sex_means %>% 
  ...
  geom_errorbar(aes(ymin = lower, # change for different metals
                    ...
                    position = position_dodge(0.9)) +
  geom_signif(comparisons = list(c("Female", "Male")), annotations = "***") +
  labs(title = "Blood Mn Levels, Males vs Females", # edit labels for diff graphs
       x = "Sex",
       y = "Blood Mn (ug/L)") 
...
hg_sex_means %>% 
  ...
  labs(title = "Blood Hg Levels, Males vs Females", # edit labels for diff graphs
       x = "Sex",
       y = "Blood Hg (ug/L)") 
...
(pb_plot + cd_plot) / (mn_plot + hg_plot)
...
(pb_life_plot + cd_life_plot + mn_life_plot) / (hg_life_plot + mehg_life_plot)
