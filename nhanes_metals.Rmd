...
nh1516_sub %>% 
  count(lbdihglc == 1) # for iHg, 75% of values are imputed (not including NAs)

nh1516_sub %>% 
  count(lbdbgelc == 1) # for ethyl Hg, 87% of values are imputed (not including NAs) 

nh1516_sub %>% 
  count(lbdbgmlc == 1) # for methyl Hg, 24% of values are imputed (not including NAs)
...
Too many participants had imputed values for inorganic Hg (75%) and ethyl Hg (87%) so that these variables are not informative. Thus, we will only examine total Hg and meHg measured in blood.
...
```{r blood metals check distributions, eval=FALSE, include=FALSE}
...
```{r blood metals skewness, eval=FALSE, include=FALSE}
...
```{r blood metals QQ plots, eval=FALSE, include=FALSE}
...
```{r blood metals check impact of influential outliers, eval=FALSE, include=FALSE}
...
```{r speciated blood Hg check distributions, eval=FALSE, include=FALSE}
...
pb_sex_means %>% 
  ...
  labs(title = "Geometric Mean Blood Pb in Males vs Females", # edit labels for diff graphs
       x = "Sex",
       y = "Blood Pb (ug/dL)",
...
cd_sex_means %>% 
  ...
  geom_errorbar(aes(ymin = lower, # change for different metals
                    ...
                    position = position_dodge(0.9)) +
  geom_signif(comparisons = list(c("Female", "Male")), annotations = "***") +
  labs(title = "Geometric Mean Blood Cd in Males vs Females", # edit labels for diff graphs
       x = "Sex",
       y = "Blood Cd (ug/dL)",
       caption = "NHANES 2015/2016 data") 
...
mn_sex_means %>% 
  ...
  geom_errorbar(aes(ymin = lower, # change for different metals
                    ...
                    position = position_dodge(0.9)) +
  geom_signif(comparisons = list(c("Female", "Male")), annotations = "***") +
  labs(title = "Geometric Mean Blood Mn in Males vs Females", # edit labels for diff graphs
       x = "Sex",
       y = "Blood Mn (ug/dL)",
       caption = "NHANES 2015/2016 data") 
...
The percentage of participants with values < LOD is too high for inorganic blood Hg (75% < LOD) and ethyl blood Hg (87% < LOD). Thus, I will only be analyzing total Hg and MeHg in blood.
...
#            mean     SE
# sexMale   48.748 0.0104
# sexFemale 51.252 0.0104
...
# Males
# Geometric mean and 95% CI
exp(-0.3880978) # 0.678346 ug/L, geometric mean for males
exp(-0.3880978 - (1.96 * 0.04220394)) # lower 95% CI
exp(-0.3880978 + (1.96 * 0.04220394)) # upper 95% CI

# Females
# Geometric mean and 95% CI
exp(-0.3880060) # 0.6784083 ug/L, geometric mean for females
exp(-0.3880060 - (1.96 * 0.05025774)) # lower 95% CI
exp(-0.3880060 + (1.96 * 0.05025774)) # upper 95% CI
# note that the exponentiated form of the mean of a log-transformed variable is the GEOMETRIC MEAN! 
...
# Males
# Geometric mean and 95% CI
exp(-0.8482905) # 0.4281462 ug/L, geometric mean for males
exp(-0.8482905 - (1.96 * 0.05858514)) # lower 95% CI
exp(-0.8482905 + (1.96 * 0.05858514)) # upper 95% CI
...
hg_sex_means %>% 
  ...
  labs(title = "Geometric Mean Blood Hg in Males vs Females", # edit labels for diff graphs
       x = "Sex",
       y = "Blood Hg (ug/L)",
       caption = "NHANES 2015/2016 data, Total Hg and MeHg") 
...
# Do the same for the hg1516_sub data (for methyl Hg)
  hg1516_sub <-
  hg1516_sub %>% 
  mutate(life_stage =
           ifelse(age < 12, "Child",
...
svyby(~log(lbxbgm), # continuous variable
  ...
  kable_styling(bootstrap_options = c("striped", "hover"),
                full_width = F) 
# add this to the life means xlsx file
...
life_means_data %>% 
  ...
  labs(title = "Geometric Mean Blood Pb in Males vs Females Across Life Stages", # edit labels for diff graphs
       x = "Life Stage",
       y = "Blood Pb (ug/dL)",
       caption = "NHANES 2015/2016 data") 
...
life_means_data %>% 
  ...
  geom_errorbar(aes(color = Sex,
                    ...
                    position = position_dodge(0.4)) +
  #geom_signif(comparisons = list(c("Female", "Male"))) +
  labs(title = "Geometric Mean Blood Cd in Males vs Females Across Life Stages", # edit labels for diff graphs
       x = "Life Stage",
       y = "Blood Cd (ug/L)",
       caption = "NHANES 2015/2016 data") 
...
life_means_data %>% 
  ...
  geom_errorbar(aes(color = Sex,
                    ...
                    position = position_dodge(0.4)) +
  #geom_signif(comparisons = list(c("Female", "Male"))) +
  labs(title = "Geometric Mean Blood Mn in Males vs Females Across Life Stages", # edit labels for diff graphs
       x = "Life Stage",
       y = "Blood Mn (ug/L)",
       caption = "NHANES 2015/2016 data") 
...
life_means_data %>% 
  ...
  geom_errorbar(aes(color = Sex,
                    ...
                    position = position_dodge(0.4)) +
  #geom_signif(comparisons = list(c("Female", "Male"))) +
  labs(title = "Geometric Mean Blood Hg (Total) in Males vs Females Across Life Stages", # edit labels for diff graphs
       x = "Life Stage",
...
life_means_data %>% 
  ...
  geom_errorbar(aes(color = Sex,
                    ...
                    width = 0.2,
                    position = position_dodge(0.4)) +
  labs(title = "Geometric Mean Blood MeHg in Males vs Females Across Life Stages", # edit labels for diff graphs
       x = "Life Stage",
       y = "Blood MeHg (ug/L)",
       caption = "NHANES 2015/2016 data") 
...
```{r lead ages 1-2, eval=FALSE, include=FALSE}
