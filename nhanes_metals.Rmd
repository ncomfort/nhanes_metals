...
# creatinine for 2015-2016 (for adjustment of urinary arsenic)
...
# LBXTHG (blood total mercury), LBXIHG (blood inorganic mercury), LBXBGE (ethyl mercury), LBXBGM (methyl mercury)
...
nh1516_sub <-
  ...
  select(SEQN, SDDSRVYR, # unique identifier and survey year 
         ...
         LBXBPB, LBXBCD, LBXTHG, LBXIHG, LBXBGE, LBXBGM, LBXBMN) # metals (exclude selenium for now)
...
test <- nh1516_sub[!is.na(nh1516_sub$wtsh2yr), ]
# this removes subjects missing the wtsh2yr variable, but some are still missing blood metal values
...
# to drop rows missing only the weight variable
nh1516_sub <-
  nh1516_sub %>% 
  drop_na(wtsh2yr)
