...
svymean(~lbxbpb, # continuous variable
        nhanes.svy) # the ”svydesign” object

# Compute the means of multiple variables
mean_metals <- svymean(~lbxbpb+lbxbcd+lbxthg+lbxihg+lbxohg+lbxbmn,
        nhanes.svy)
